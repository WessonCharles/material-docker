...
goog.require('ng./ Core uses $animate
    'material.animate');
goog.require('ng./ for $animateCss polyfill with Angular < 1.4
    'material.core.gestures');
goog.require('ng./ for $mdGesture
    'material.core.theming'      // for $mdThem');
