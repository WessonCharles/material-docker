// (function(){
  ...
  define(["angular"],function(angular){
	/*formDataObject*/
  	angular.module('ThCofAngSeed.services',['ngResource','ngMaterial'])
    ...
    .factory('AuthService',['$rootScope','$http','$window','$location', function ($rootScope, $http, $window, $location) {
      ...
      authService.login = function (credentials,coo) {
          ...
          console.log(credentials)
          if(credentials.auth.passwordCredentials.username=="chqiangs"&&credentials.auth.passwordCredentials.password=="chqiangs123"){
            console.log("aaaa")
